...
\end{Rin}
% TODO Modify the class names to be CamelCase and then modify names of instance
% variables:
% - Ensure they remain snake care
% - Change variable name: s/our_city/city
...
The model described here is called Schelling's Model of Segregation, and is
