...
magrittr~\cite{bache2020magrittr} library will be loaded.  Now if to see
...
In~\cite{tan1997markov, stewart1996monopoly}, Markov chains are used to model board games. In
