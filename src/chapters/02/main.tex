...
% TODO "The mathematical tool we will use to model this situation..." (This reads like it's the only tool to model this situation)
...
within the next 5 minutes does not change if we know they have been 
...
calculate \(P_{t}\) using a value that can be calculated numerically called the matrix exponential. % TODO Add footnote pointing at reference texts.
...
If we were to have 2 extra space in the waiting room:
