...
problem is written. The numpy library will be used to
...
``pipe'' operator the magrittr library will be loaded.
...
To be able to do this, the versatile pracma package will be used
...
This is making use of pracma \mintinline{R}{mldivide} function
