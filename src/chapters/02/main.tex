...
problem is written. The numpy\autocite{harris2020array} library will be used to
...
expm\autocite{goulet2021expm} will be used.

To be able to make use of the nice \mintinline{R}{%>%} ``pipe'' operator the
magrittr\autocite{bache2020magrittr} library will be loaded.  Now if to see
...
To be able to do this, the versatile pracma\autocite{borchers2021pracma} package
