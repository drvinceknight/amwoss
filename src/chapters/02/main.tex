...
\begin{itemize}
    ...
    \item Booleans -- \mintline{bool} -- for example \mintinline{python}{True} or
...
\mintinline{for} loop. For example, the following code will iterate over the
...
\mintinline{ciw} open your command line interface and type the following:
...
\mintinline{ciw} available to you:
...
\begin{itemize}
    ...
    \item Booleans -- \mintline{logical} -- for example \mintinline{R}{True} or
        \mintinline{R}{False}.
\end{itemize}
