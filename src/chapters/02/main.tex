...
state after \(t\) time unis. This is can be represented mathematically using a
...
give a description of how to compute the matrix exponential
...
def get_transition_rate(
    ...
    return 0
\end{pyin}
% TODO Do we need `and in_state < capacity`?
...
% TODO Do we need `if (in_state < capacity)`?
