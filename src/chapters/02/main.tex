...
can be solved directly in order to get a solution where equilibrium is
guaranteed.
...
expm~\cite{goulet2021expm} will be used.
To be able to make use of the nice \mintinline{R}{%>%} ``pipe'' operator the
magrittr~\cite{bache2020magrittr} library will be loaded. Now to see
...
of steady state probabilities. There are in fact many more theoretic and applied
