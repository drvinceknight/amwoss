...
Flynn's taxonomy~\autocite{flynn1966very}. This is a type of parallelisation
...
these the following textbook is recommended:~\parencite{stewart2009probability}.

In \parencite{tan1997markov, stewart1996monopoly}, Markov chains are used to model board games. In
\parencite{tan1997markov} a model of the battles that take place on a Risk board is used
to understand the probalities of invasion of territories based on troupe
numbers. This is done using an absorbing Markov chain. In
\parencite{stewart1996monopoly} a
...
queueing systems applied to healthcare. In \parencite{griffiths2013modelling} a
...
In \parencite{white1993survey} a literature review is given showing a wide
