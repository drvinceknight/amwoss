...
solutions. An survey is given in~\parencite{braekers2016vehicle}. Variations of
the problem include multiple, heterogeneous and/or capacitated vehicles, and
stochastic or time-dependent travel times. A recently adaptation of the problem
is the green vehicle routing problem~\parencite{moghdani2021green}, where the
cost function includes considerations around green house gas emissions and other
pollutants.
...
a genetic algorithm is used to build a prediction model predicting locations of
