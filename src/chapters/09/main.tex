...
function that creates an initial tour\footnote{Numpy~\autocite{harris2020array}
...
\begin{figure}
    ...
    Python. This plot is
    obtained using the Python library matplotlib~\parencite{hunter2007matplotlib},
    R has an excellent plotting library: ggplot2~\parencite{wickham2016ggplot2}.}
...
of one of these problems, formally described first in~\autocite{menger1932}, although
