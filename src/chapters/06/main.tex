...
example extensive form games which are represented by trees and more explicitly model
...
behaviour. Axelrod~\cite{axelrod1990evolution} started this work with
computer tournaments where he invited code submissions of strategies to play a
game called the Iterated Prisoner's Dilemma. The outcome of this was an
