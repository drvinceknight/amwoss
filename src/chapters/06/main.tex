...
matrix expected profits and any offset. The Nashpy\autocite{knight2018nashpy}
and numpy\autocite{harris2020array} libraries will be used for this.
...
will choose to use Recon\autocite{oliveira2019recon} which has functionality for finding the
