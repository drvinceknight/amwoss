...
example extensive form which are represented by trees and more explictely model
asyncronous decision making. Other solution concepts involve the specific study
...
scenarios for ambulance diversion: a pracitce where an emergency room will
