...
equilibrium, such emergent processes are the topics of evolutionary game theory,
learning algorithms and/or agent based modelling.
% TODO Add footnote reference and pointer to ABS chapter.
