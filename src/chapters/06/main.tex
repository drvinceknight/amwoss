...
From Table~\ref{tbl:profit-of-taxi-companies} it can be seen that if Company B
...
% Moeschler's textbook

% Nash's paper has a nice "little" application to Poker.
% Point at the ambulance diversion paper
% ZD strategies

% Further work: evolutionary work as well as pointing at ABM
% Survey paper: find one like Nik's. There was a semantic one looking at
% cooperation.
