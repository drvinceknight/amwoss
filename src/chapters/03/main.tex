...
claimed: ``Anyone who considers arithmetical methods of producing random digits % TODO I do not understand this quite and don't think it's relevant.
...
These trajectories are not very useful alone, the resources used are yet to be defined,
