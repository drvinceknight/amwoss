...
The blood supply chain is one of many areas within healthcare where discrete
event simulation is used. A general overview is given
in~\parencite{brailsford2009analysis}.

% TODO Add a Hybrid paper.
