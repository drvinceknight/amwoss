...
discussion of pseudo random numbers is~\cite{von195113} where the author
...
In this book we will use the Simmer~\cite{ucar2019simmer} package in order to conduct discrete event
