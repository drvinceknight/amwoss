...
% TODO Are we consistent with pointers at chapters? Sometimes in brackets and
% sometimes in footers.
...
One domain where simulation is often used is in modelling healthcare systems.
