...
In this book the Ciw\autocite{ciwpython, palmer2019ciw}
...
than 0.5 hours the pandas\autocite{reback2020pandas, mckinney-proc-scipy-2010}
...
In this book we will use the Simmer\autocite{ucar2019simmer} package in order to conduct discrete event
