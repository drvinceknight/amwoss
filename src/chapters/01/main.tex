...
this book is for you. We will introduce you to the world of open source % TODO
% Is Introduce the correct word here? Does introduce imply they need to not know
% any python or R to start with this book? (Which is not correct). I cannot
% think of a better word, perhaps: "show"?
...
% TODO Is "programmes" the correct spelling?
...
% TODO Do we want something here to introduce the reader to the rest of the
% book?
% "Thank you for picking up this book, we hope one if not all of the following
% chapters proves interesting and useful to you.
