Thank you for starting to read this book. This book aims to bring
...
\item
  ...
  technically you do not need this to be able to use the tools in this
  book, the topics covered use some Algebra, Calculus and Probability.
\end{itemize}
...
The other author, Geraint, used mathematics to find a good set of
...
% TODO Geraint does any of this make poke sense?.
...
it's a community of practice. Bugs are fixed faster, research is
...
very clear mechanisms for communicating with the developers and even
