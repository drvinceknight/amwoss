...
the python library Ciw is used whereas an alternative could be to use a python
library called Simpy.
...
\begin{figure}
    \begin{center}
        ...
        \caption{The relationship between modularisation, documentation and
            ...
            the drawing of this diagram.}  % TODO Ask Nik if she's OK with this.
