...
you cannot open up and read things then you should not trust it (this is
...
\begin{figure}
    \begin{center}
        ...
        \caption{The relationship between modularisation, documentation and testing} %TODO reference this
