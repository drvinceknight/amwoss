...
\section{Wider context}\label{sec:research}
...
to be of use today in a wide range of areas:
\parentcite{vazquez2020system} gives a literature review of the application area
...
% TODO Point at hybrid but from a different pov.
