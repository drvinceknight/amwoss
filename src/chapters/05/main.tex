...
using Python and the Matplotlib library\autocite{hunter2007matplotlib}. R has powerful
plotting tools with packages such as ggplot2\autocite{wickham2016ggplot2}.}
