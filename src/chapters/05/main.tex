...
Here the \mintinline{python}{solve_ivp} method of the SciPy\autocite{2020SciPy-NMeth}
...
\end{center}
\caption{Stock levels without vaccination. This plot is obtained using the
    Python library matplotlib~\parencite{hunter2007matplotlib}, R has an excellent
    plotting library: ggplot2~\parencite{wickham2016ggplot2}.}
...
\end{center}
\caption{Stock levels with vaccination. This plot is obtained using the Python
    library matplotlib~\parencite{hunter2007matplotlib}, R has an excellent
    plotting library: ggplot2~\parencite{wickham2016ggplot2}.}
