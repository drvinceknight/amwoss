...
The above scenario is called a compartmental model of illness, and can be shown
...
the illness becomes endemic. We can estimate once this steadiness occurs, around
...
With vaccination the illness remains endemic, however now we estimate that once,
